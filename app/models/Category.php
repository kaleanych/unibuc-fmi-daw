...
//            'price_desc' => 'ORDER BY price DESC',
        ...
        return R::getAll(Item::addAuthorSQL("SELECT i.*, id.*, %s FROM items i JOIN item_descriptions id on i.id = id.item_id %s WHERE i.status = 1 AND i.category_id IN ($ids) AND id.language_id = ? $order_by LIMIT $start, $per_page"), [$lang['id'], $lang['id']]);
    }
