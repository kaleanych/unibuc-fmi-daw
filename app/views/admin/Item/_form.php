            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-outline card-success">
                        ...
                        <div class="card-body">
                            <button class="btn btn-success" id="add-base-img" onclick="popupBaseImage(); return false;">Upload</button>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-outline card-success">
                        ...
                        <div class="card-body">
                            <button class="btn btn-success" id="add-gallery-img" onclick="popupGalleryImage(); return false;">Upload</button>
                        ...
                        <?php foreach (\wfm\App::$app->getProperty('languages') as $k => $lang): ?>
                            <div class="tab-pane fade <?php if ($lang['base']) echo 'active show' ?>" id="<?= $k ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="item_description[<?= $lang['id'] ?>][title]" class="form-control" id="<?= $lang['id'] ?>_title" placeholder="Title" value="<?= get_field_array_value('item_description', $lang['id'], 'title') ?>">
                                </div>

                                <div class="form-group">
                                    <label for="<?= $lang['id'] ?>_description">Description</label>
                                    <input type="text" name="item_description[<?= $lang['id'] ?>][description]" class="form-control" id="<?= $lang['id'] ?>_description" placeholder="Description" value="<?= get_field_array_value('item_description', $lang['id'], 'description') ?>">
                                </div>

                                <div class="form-group">
                                    <label for="<?= $lang['id'] ?>_keywords">Keywords</label>
                                    <input type="text" name="item_description[<?= $lang['id'] ?>][keywords]" class="form-control" id="<?= $lang['id'] ?>_keywords" placeholder="Keywords" value="<?= get_field_array_value('item_description', $lang['id'], 'keywords') ?>">
                                </div>

                                <div class="form-group">
                                    <label for="<?= $lang['id'] ?>_excerpt" class="required">Excerpt</label>
                                    <input type="text" name="item_description[<?= $lang['id'] ?>][excerpt]" class="form-control" id="<?= $lang['id'] ?>_excerpt" placeholder="Excerpt" value="<?= get_field_array_value('item_description', $lang['id'], 'excerpt') ?>">
                                </div>

                                <div class="form-group">
                                    <label for="<?= $lang['id'] ?>_content">Content</label>
                                    <textarea name="item_description[<?= $lang['id'] ?>][content]" class="form-control editor" id="<?= $lang['id'] ?>_content" rows="3" placeholder="Content"><?= get_field_array_value('item_description', $lang['id'], 'content') ?></textarea>
                                </div>
