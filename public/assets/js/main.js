$(function() {
	...
	$('#input-sort').on('change', function () {
		window.location = SITE_URL + window.location.pathname + '?' + $(this).val();
	});
	...
	$('#languages button').on('click', function () {
		...
		window.location = SITE_URL + '/language/change?lang=' + lang_code;
	});

	$('.item-card').on('click', '.add-to-wishlist', function (e) {
		e.preventDefault();
		const id = $(this).data('id');
		const $this = $(this);
		$.ajax({
	...
	$('.item-card').on('click', '.delete-from-wishlist', function (e) {
		e.preventDefault();
		const id = $(this).data('id');
		const $this = $(this);
		$.ajax({
